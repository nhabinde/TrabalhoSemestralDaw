...
@section('conteudo')
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="header">
                    <h2>Informação de <strong>Docente</strong> <small>Cadastrar Docente</small></h2>
                </div>
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <div class="form-group  col-md-4 ">
                            ...
                            <input required="" type="text" class="form-control @error('apelido') is-invalid @enderror" name="apelido" placeholder="Apelido"
                                   value="{{ old('apelido') }}">
                        ...
                        <div class="form-group  col-md-6 ">
                            ...
                            <input required="" type="text" class="form-control @error('nacionalidade') is-invalid @enderror" name="nacionalidade"
                        ...
                        <div class="form-group  col-md-6 ">
                            ...
                            <input required="" type="text" class="form-control @error('naturalidade') is-invalid @enderror" name="naturalidade"
                        ...
                        <div class="form-group  col-md-6 ">
                            ...
                            <input type="date" class="form-control @error('data_de_nascimento') is-invalid @enderror" name="data_de_nascimento"
                        ...
                        <div class="form-group  col-md-6 ">
                            ...
                            <input required="" type="text" class="form-control @error('morada') is-invalid @enderror" name="morada" placeholder="Morada"
                                   value="{{old('morada')}}">
                        ...
                        <div class="form-group  col-md-6 ">
                            ...
                            <input type="text" class="form-control @error('email_pessoal') is-invalid @enderror" name="email_pessoal" placeholder="Email Pessoal"
                        ...
                        <div class="form-group  col-md-6 " id="number">
                            ...
                            <input type="number" class="form-control @error('celular') is-invalid @enderror" name="celular" required="" step="any"
                        ...
                        <div class="form-group  col-md-6 " id="number1">
                            ...
                            <input type="number" class="form-control @error('celular2') is-invalid @enderror" name="celular2" required="" step="any"
