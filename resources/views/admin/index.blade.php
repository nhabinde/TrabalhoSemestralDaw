...
{{--                            <div class="body">--}}
{{--                                <h2 class="number count-to m-t-0" data-from="0" data-to="{{$cursos}}" data-speed="1000" data-fresh-interval="700">--}}
{{--                                    {{$cursos}}</h2>--}}
...
{{--                        </div>--}}
                        <div class="col-lg-6 col-md-6 col-sm-12 text-center">
                            <div class="body">
                                <h2 class="number count-to m-t-0" data-from="0" data-to="{{$docentes}}" data-speed="2000" data-fresh-interval="700">
                                    {{$docentes}}</h2>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 text-center">
                            <div class="body">
                                <h2 class="number count-to m-t-0" data-from="0" data-to="{{$estudantes}}" data-speed="2000" data-fresh-interval="700">{{$estudantes}}</h2>
                                <p class="text-muted">Estudantes</p>
                                <span id="linecustom3">19,5,3,6,6,3,6,8,4,7</span>
                            </div>
                        </div>
                    </div>
                </div>
